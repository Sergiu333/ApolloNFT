      ...
      <div className='flex flex-col lg:flex-row justify-between'>
        <div className='flex flex-col font-extrabold text-[41px] leading-[40px] md:text-[94px] md:leading-[90px]'>
          ...
          <div className='flex flex-row'>
            ...
            <Image className='py-[19.5px] hidden lg:block' src='/star.svg' alt='logo' width={84} height={84} />
          </div>

          <div className='mt-[32px] flex flex-col md:flex-row gap-[30px]'>
            <button
              className='hidden md:flex items-center justify-center w-[120px] h-[120px] btn-description gradient rounded-full font-semibold text-[16px] leading-[26px]'>
              Discover NFT
            </button>
            ...
            <div
              className='block md:hidden text-[16px] leading-[19px] font-semibold bg-[#1C51FE] rounded-[66px] py-[16px] w-full text-center flex justify-center'>
              Discover NFT
            </div>
          </div>
        </div>
